...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        resolved_attention_mask = attention_mask if encoder_hidden_states is None else encoder_attention_mask
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if _is_main_process():
            ...
            logger.info("Action DiT parameters (trainable): %s", f"{num_trainable:,}")
